...
${OBJECTDIR}/BB_QUEUE.o: BB_QUEUE.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/BB_QUEUE.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/BB_QUEUE.o.d" -o ${OBJECTDIR}/BB_QUEUE.o BB_QUEUE.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/BB_QUEUE.o: BB_QUEUE.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/BB_QUEUE.o.d 
	@${RM} ${OBJECTDIR}/BB_QUEUE.o 
	@${FIXDEPS} "${OBJECTDIR}/BB_QUEUE.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/BB_QUEUE.o.d" -o ${OBJECTDIR}/BB_QUEUE.o BB_QUEUE.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
