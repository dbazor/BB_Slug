...
SOURCEFILES_QUOTED_IF_SPACED=../../BB_Library/BB_BOARD.c ../../BB_Library/BB_LEDS.c ../../BB_Library/BB_UART.c BB_I2C.c ../../BB_Library/BB_Encoder.c ../../BB_Library/BB_Motor.c IMU_Main_Test.c ../../BB_Library/BNO55_I2C_driver.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/418195140/BB_BOARD.o ${OBJECTDIR}/_ext/418195140/BB_LEDS.o ${OBJECTDIR}/_ext/418195140/BB_UART.o ${OBJECTDIR}/BB_I2C.o ${OBJECTDIR}/_ext/418195140/BB_Encoder.o ${OBJECTDIR}/_ext/418195140/BB_Motor.o ${OBJECTDIR}/IMU_Main_Test.o ${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/418195140/BB_BOARD.o.d ${OBJECTDIR}/_ext/418195140/BB_LEDS.o.d ${OBJECTDIR}/_ext/418195140/BB_UART.o.d ${OBJECTDIR}/BB_I2C.o.d ${OBJECTDIR}/_ext/418195140/BB_Encoder.o.d ${OBJECTDIR}/_ext/418195140/BB_Motor.o.d ${OBJECTDIR}/IMU_Main_Test.o.d ${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/418195140/BB_BOARD.o ${OBJECTDIR}/_ext/418195140/BB_LEDS.o ${OBJECTDIR}/_ext/418195140/BB_UART.o ${OBJECTDIR}/BB_I2C.o ${OBJECTDIR}/_ext/418195140/BB_Encoder.o ${OBJECTDIR}/_ext/418195140/BB_Motor.o ${OBJECTDIR}/IMU_Main_Test.o ${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o

# Source Files
SOURCEFILES=../../BB_Library/BB_BOARD.c ../../BB_Library/BB_LEDS.c ../../BB_Library/BB_UART.c BB_I2C.c ../../BB_Library/BB_Encoder.c ../../BB_Library/BB_Motor.c IMU_Main_Test.c ../../BB_Library/BNO55_I2C_driver.c
...
${OBJECTDIR}/BB_I2C.o: BB_I2C.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/BB_I2C.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"../../BB_Library" -MMD -MF "${OBJECTDIR}/BB_I2C.o.d" -o ${OBJECTDIR}/BB_I2C.o BB_I2C.c   -legacy-libc
...
${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o: ../../BB_Library/BNO55_I2C_driver.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/418195140 
	@${RM} ${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o.d 
	@${RM} ${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"../../BB_Library" -MMD -MF "${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o.d" -o ${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o ../../BB_Library/BNO55_I2C_driver.c   -legacy-libc
...
${OBJECTDIR}/BB_I2C.o: BB_I2C.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/BB_I2C.o.d 
	@${RM} ${OBJECTDIR}/BB_I2C.o 
	@${FIXDEPS} "${OBJECTDIR}/BB_I2C.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"../../BB_Library" -MMD -MF "${OBJECTDIR}/BB_I2C.o.d" -o ${OBJECTDIR}/BB_I2C.o BB_I2C.c   -legacy-libc
...
${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o: ../../BB_Library/BNO55_I2C_driver.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o.d 
	@${RM} ${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"../../BB_Library" -MMD -MF "${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o.d" -o ${OBJECTDIR}/_ext/418195140/BNO55_I2C_driver.o ../../BB_Library/BNO55_I2C_driver.c   -legacy-libc
...
dist/${CND_CONF}/${IMAGE_TYPE}/IMU_Test.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/IMU_Test.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -legacy-libc  -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/IMU_Test.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/IMU_Test.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -legacy-libc -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/IMU_Test.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
