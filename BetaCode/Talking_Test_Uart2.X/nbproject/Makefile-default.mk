...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Talking_Test_Uart2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=BB_BOARD.c BB_QUEUE.c Talking_Test.c BB_Bluetooth.c BB_UART.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/BB_BOARD.o ${OBJECTDIR}/BB_QUEUE.o ${OBJECTDIR}/Talking_Test.o ${OBJECTDIR}/BB_Bluetooth.o ${OBJECTDIR}/BB_UART.o
POSSIBLE_DEPFILES=${OBJECTDIR}/BB_BOARD.o.d ${OBJECTDIR}/BB_QUEUE.o.d ${OBJECTDIR}/Talking_Test.o.d ${OBJECTDIR}/BB_Bluetooth.o.d ${OBJECTDIR}/BB_UART.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/BB_BOARD.o ${OBJECTDIR}/BB_QUEUE.o ${OBJECTDIR}/Talking_Test.o ${OBJECTDIR}/BB_Bluetooth.o ${OBJECTDIR}/BB_UART.o

# Source Files
SOURCEFILES=BB_BOARD.c BB_QUEUE.c Talking_Test.c BB_Bluetooth.c BB_UART.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Talking_Test_Uart2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/BB_Bluetooth.o: BB_Bluetooth.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/BB_Bluetooth.o.d 
	@${RM} ${OBJECTDIR}/BB_Bluetooth.o 
	@${FIXDEPS} "${OBJECTDIR}/BB_Bluetooth.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"../BB_Library" -MMD -MF "${OBJECTDIR}/BB_Bluetooth.o.d" -o ${OBJECTDIR}/BB_Bluetooth.o BB_Bluetooth.c   -legacy-libc
...
${OBJECTDIR}/BB_Bluetooth.o: BB_Bluetooth.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/BB_Bluetooth.o.d 
	@${RM} ${OBJECTDIR}/BB_Bluetooth.o 
	@${FIXDEPS} "${OBJECTDIR}/BB_Bluetooth.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"../BB_Library" -MMD -MF "${OBJECTDIR}/BB_Bluetooth.o.d" -o ${OBJECTDIR}/BB_Bluetooth.o BB_Bluetooth.c   -legacy-libc
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Talking_Test_Uart2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Talking_Test_Uart2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -legacy-libc  -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Talking_Test_Uart2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Talking_Test_Uart2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -legacy-libc -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Talking_Test_Uart2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
